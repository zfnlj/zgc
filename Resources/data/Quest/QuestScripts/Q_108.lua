...
Initialize = function(quest)
	quest:SetAttrs("prevQuest=0;abandon=0;acceptLevel=1;level=1;exp=42;money=21;");
	quest:SetAttrs("nameId=108;talk=0;desc=108;");
	quest:SetAttrs("type=3;reuse=0;hardDegree=8;achieveId=0;");
	quest:SetAttrs("nextQuest=0;achievement=0;timeperiod=0;");
	quest:SetAttrs("battleField=108;");
	
	-- Group 0
	local group0 = quest:CreateTargetGroup("and");
        group0:CreateTarget("KillMonster", "npc=108;count=1;");
  -- end groups
	return true;
end,
