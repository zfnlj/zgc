...
Initialize = function(quest)
	quest:SetAttrs("prevQuest=10004;abandon=0;acceptLevel=1;level=1;exp=25;money=10;");
	...
	quest:SetAttrs("nextQuest=10006;achievement=0;timeperiod=0;");
	quest:SetAttrs("battleField=5;");
	
	-- Group 0
	local group0 = quest:CreateTargetGroup("and");
        group0:CreateTarget("KillMonster", "npc=10005;count=1;");
  -- end groups
	return true;
end,
