...
namespace System { namespace Thread {
	...
	void KTPWorkPool::Initialize(unsigned int iMaxWorkerThreads,unsigned int iMaxPrioritys,KThreadUnitNodePool* pThreadUnitNodePool)
	{
		...
		KThreadPool::Initialize(iMaxWorkerThreads, iMaxPrioritys, pThreadUnitNodePool);
	}
