...
void KLogicModuleMsgDealer::RegisterAllMsg()
{
	...
	RegisterMsg<KBattleMsgHub>(LOGIC_BATTLE_DOUBLEDRAW, &KMsgHub::getSingleton().GetBattleMsgHub(), &KBattleMsgHub::DoubleDraw);
	...
	RegisterMsg<KBattleMsgHub>(LOGIC_BATTLE_SKILLINTERRUPT, &KMsgHub::getSingleton().GetBattleMsgHub(), &KBattleMsgHub::SkillInterrupt);
