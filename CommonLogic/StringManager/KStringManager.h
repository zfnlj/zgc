...
typedef System::Collections::KHashTable<DWORD,char*,KLessCompare<DWORD,KLess<DWORD> >,KHasher<DWORD>,System::Sync::KMTLock,2048,2048> KStringHashMap;
...
public:
	...
	BOOL InitByDataFile(const char* filename , BOOL bCover=TRUE);
private:
	//// 检查该字符是否包含非法字符，不做替换
...
public:
	BeginDefLuaClassNoCon(KStringManager)
		DefMemberFunc(GetStringByID);
	EndDef
};
