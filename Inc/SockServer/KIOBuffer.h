...
//#ifndef PIECE_BUFFER_COUNT
//#define PIECE_BUFFER_COUNT 2048
//#endif

//typedef KPieceBuffer<2048> KBuffer2048;
...
typedef System::Memory::KStepObjectPool<KBuffer2048,128,System::Sync::KMTLock> KIOBuffPool_2048;

class KIOBuffer
{
public:
	typedef System::Collections::KSDSelfList<KBuffer2048> BufferQueue;
...
private:
	...
	int _PeekPiece(KBuffer2048* piece, char* pData, int len);
...
public:
	...
	{
		int readed = 0;
		const char* dst = (const char*)pData;
